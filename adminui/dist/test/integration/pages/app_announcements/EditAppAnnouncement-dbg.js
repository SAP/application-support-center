sap.ui.define([
	...
	var sViewName = "app_announcements.EditAppAnnouncement";

	Opa5.createPageObjects({
		onTheEditAppAnnouncementPage : {
			baseClass : Common,
			pageName : sViewName,
			actions : {
			...
			assertions : {
				...
				iShouldSeeThePageTitle: function () {
						return this.waitFor({
							viewName : sViewName,
							id : "idTitle",
							matchers : new PropertyStrictEquals({name : "text", value : "Edit Announcement Page"}),
							success : function () {
